...
python3 ./diagnostics_plotting.py --model_data testdata/latest/fcst_10si.grib2 --dynamic_nwc_data testdata/latest/mnwc_10si.grib2 --output_data testdata/latest/output/interpolated_10si.grib2 --parameter 10si --mode model_fcst_smoothed --predictability 4 --plot_diagnostics "yes"
