...
### NEW CALLS
python2 debugging.py --obs_data testdata/2019020409/obs_2t.grib2 --model_data testdata/2019020409/fcst_2t.grib2 --output_data testdata/2019020409/output/interpolated_2t.grib2 --parameter Temperature --mode analysis_fcst_smoothed --predictability 4 --plot_diagnostics "yes"
python2 debugging.py --obs_data testdata/2019020409/obs_2r.grib2 --model_data testdata/2019020409/fcst_2r.grib2 --output_data testdata/2019020409/output/interpolated_2r.grib2 --parameter Dewpoint --mode analysis_fcst_smoothed --predictability 4 --plot_diagnostics "yes"
python2 debugging.py --obs_data testdata/2019020409/obs_msl.grib2 --model_data testdata/2019020409/fcst_msl.grib2 --output_data testdata/2019020409/output/interpolated_msl.grib2 --parameter msl --mode analysis_fcst_smoothed --predictability 4 --plot_diagnostics "yes"
python2 debugging.py --obs_data testdata/2019020409/obs_10si.grib2 --model_data testdata/2019020409/fcst_10si.grib2 --output_data testdata/2019020409/output/interpolated_10si.grib2 --parameter win10 --mode analysis_fcst_smoothed --predictability 4 --plot_diagnostics "yes"
python2 debugging.py --model_data testdata/TCC/smartmet.grib2 --dynamic_nwc_data testdata/TCC/mnwc.grib2 --output_data testdata/TCC/output/smoothed_mnwc_TCC.grib2 --parameter total_cloud_cover --mode model_fcst_smoothed --predictability 9 --plot_diagnostics "yes"
