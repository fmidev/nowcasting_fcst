...
#python3 ./call_interpolation.py --model_data testdata/$HOD/fcst_2t.grib2 --dynamic_nwc_data testdata/$HOD/mnwc_2t.grib2 --output_data testdata/$HOD/output/interpolated_2t.grib2 --parameter 22t --mode model_fcst_smoothed --predictability 4 --plot_diagnostics $PLOT_DIAGNOSTICS
